...
public class LayerDefinitionMixin implements ILayerDefinition {
    ...
    @Override
    public ModelPart bakeRootWithBends(Map<String, Pair<Direction, Integer>> cuboidDataMap) {
        return ((IPartDefinition)this.mesh.getRoot()).bakeBendablePart(this.material.xTexSize, this.material.yTexSize, cuboidDataMap, "root");
    }
}
